...
export async function updateProfile(
	...
	const res = await profileApi.patch("/users/me", input);
	return res.data;
}
...
export async function uploadAvatar(file: File): Promise<IUser> {
	...
	const res = await profileApi.put("/users/me/avatar", form);
	return res.data;
}

export async function deleteAvatar(): Promise<IUser> {
	const res = await profileApi.delete("/users/me/avatar");
	return res.data;
}
...
export async function uploadBanner(file: File): Promise<IUser> {
	...
	const res = await profileApi.put("/users/me/banner", form);
	return res.data;
}

export async function deleteBanner(): Promise<IUser> {
	const res = await profileApi.delete("/users/me/banner");
	return res.data;
}
